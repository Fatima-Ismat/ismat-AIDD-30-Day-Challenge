...
Here, you write down the exact requirements of your project. This includes what features or functions are needed and what the expected results are.

3️⃣ /Plan

In this step, you make a plan to complete your project. You decide the order of tasks, set timelines, and list resources you need.

4️⃣ /Tasks

This step breaks your plan into smaller, easy-to-do actions. Each task should be simple and clear so you can complete it step by step.
